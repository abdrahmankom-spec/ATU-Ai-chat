...
import { EngineInterface, GenerateProgressCallback, InitProgressCallback, InitProgressReport } from "./types";
...
export declare class EngineWorkerHandler {
     ...
     *   DOM API directly.
     */
    constructor(engine: EngineInterface, postMessageHandler?: PostMessageHandler, initProgressCallback?: (report: InitProgressReport) => void);
